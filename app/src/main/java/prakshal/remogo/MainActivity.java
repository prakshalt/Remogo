...
public class MainActivity extends AppCompatActivity {
    ...
    int simstatus;
    String msisdn;
    String perms[]={Manifest.permission.RECEIVE_SMS,Manifest.permission.CHANGE_NETWORK_STATE,Manifest.permission.CHANGE_WIFI_STATE,Manifest.permission.ACCESS_WIFI_STATE,Manifest.permission.ACCESS_NETWORK_STATE,Manifest.permission.BROADCAST_SMS,Manifest.permission.MODIFY_AUDIO_SETTINGS,Manifest.permission.READ_CONTACTS,Manifest.permission.READ_PHONE_STATE,Manifest.permission.SEND_SMS};
